...
#### 3. server 运行
  ...
  运行之后，可以，就还想写一个[sundry/openvpn/init.d](https://github.com/alingse/sundry/tree/master/openvpn/init.d)的管理工具
   
  贴一部分代码[sundry/openvpn/init.d/openvpn](https://github.com/alingse/sundry/tree/master/openvpn/init.d/openvpn.server)
...
#### 4. client 配置／连接
  ...
  同时照例可以编写出[init.d/openvpn](https://github.com/alingse/sundry/tree/master/openvpn/init.d/openvpn.client)
